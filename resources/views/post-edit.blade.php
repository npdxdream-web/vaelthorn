    ...
    <div class="rounded-xl border border-border bg-bg-elevated p-6">
        ...
        <form method="POST" action="{{ route('post.update', $post->id) }}" id="edit-post-form">
            ...
            <div class="mb-6">
                ...
                <div id="post-editor" class="thread-reading {{ $isLorePost ? 'lore-post-body' : '' }} min-h-[220px] p-4 text-[#e8e6e3]"></div>
                <div id="post-preview" class="thread-reading {{ $isLorePost ? 'lore-post-body' : '' }} prose prose-invert max-w-none hidden p-4"></div>
