    ...
    <div class="flex h-16 w-full items-center justify-between px-4 sm:px-5">
        ...
        <div class="flex items-center gap-1">
            ...
            <a href="{{ route('players.index') }}"
               class="flex h-10 w-10 items-center justify-center rounded-lg transition-colors {{ in_array($currentRoute ?? '', ['players.index', 'leaderboard.index']) ? 'bg-border text-gold' : 'text-text-muted hover:text-gold' }}"
               title="ทำเนียบสมาชิก">
                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857m0 0a5.002 5.002 0 00-9.288 0M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
            </a>
            @if(isset($character) && $character)
